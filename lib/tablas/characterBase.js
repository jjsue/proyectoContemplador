...
const clases = {
    ...
    guerrero: {
        varios: {
            ...
            posiblesArmaduras: [armaduras.armaduraPesada.armaduraLaminada, armaduras.armaduraPesada.armaduraPlacasMallas, armaduras.armaduraPesada.cotaDeBandas, armaduras.armaduraPesada.armaduraCompleta, armaduras.armaduraIntermedia.pieles, armaduras.armaduraIntermedia.cotaDeEscamas, armaduras.armaduraIntermedia.cotaDeMallas, armaduras.armaduraIntermedia.cotaDeBandas],
            posiblesEscudos: [armaduras.escudos.escudoLigeroMadera, armaduras.escudos.escudoLigeroAcero, armaduras.escudos.escudoPesadoAcero, armaduras.escudos.escudoPesadoMadera, armaduras.escudos.escudoPaves, armaduras.escudos.broquel, armaduras.escudos.rodela],
        },
        1: {
            ataqueBase: 1,
            salvaciones: {
    ...
    hechicero: {
        varios: {
            ...
            ph: 2,
            posiblesArmas: {
                cuerpo: [armas.armasSencillas.armasLigerasCaC.daga, armas.armasSencillas.armasLigerasCaC.guanteleteArmado, armas.armasSencillas.armasLigerasCaC.hoz, armas.armasSencillas.armasLigerasCaC.mazaLigera, armas.armasSencillas.armasLigerasCaC.puñal, armas.armasSencillas.armasUnaManoCaC.clava, armas.armasSencillas.armasLigerasCaC.mazaDeArmas, armas.armasSencillas.armasLigerasCaC.mazaPesada, armas.armasSencillas.armasLigerasCaC.lanzaCorta, armas.armasSencillas.armasDosManosCaC.baston, armas.armasSencillas.armasDosManosCaC.lanza, armas.armasSencillas.armasDosManosCaC.lanzaLarga],
